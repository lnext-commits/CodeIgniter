...
<html>
	...
	<body >
		<form method="post">
			<img src="resurUs/images/go-home3.png" class="gohome iqonav cur" onclick="window.location.pathname='main'">
		...
		<div id="box_head">
			...
			<div id="box_classnomber" class="box_headmenu"><span class="textHeadMenu"><?php echo $nc ?>-Б</span></div>		
		</div>
		<div class="clean"></div>
		<hr>
		<div id="box_content">